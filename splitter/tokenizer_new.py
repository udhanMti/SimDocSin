...
class SinhalaTokenizer(Tokenizer):
    def __init__(self):
        ...
        self.short_forms: List[Text] = [
            ...
            'පී.', 'කිව්.', 'ආර්.', 'එස්.', 'යූ.', 'වී.', 'ඩබ.', 'ඩබ්ලිව්.', 'ඩබ්.',
            'එක්ස්.', 'වයි.', 'ඉසෙඩ්.',
            'පෙ.', 'ව.',
            'රු.',
            'පා.',  # parliment
            ...
            'අ.', 'ආ.', 'ඇ.','ඈ.','ඉ.','ඊ.','උ.',
            '(අ).', '(ආ).', '(ඇ).', '(ඈ).', '(ඉ).','(ඊ).','(උ).',
            'කි.මි.','ලී.', 'මී.', 'ශ්‍රී.', 'එ්.', 'ක්‍ර.', 'ජි.',
            'ජා.','වෘ.','සු.', 'සෞ.', 'පි.', 'බි.','ඩි.',
            'ප්‍ර.','මා.', 'සං.', 'ව්‍ය.', 'අංක:','අංකය:', 'දු.','අං.','ප්‍රා.','ලේ.','කො.',
             'පො.', 'ස.', 'ල.', 'ලො.', 'ට.', 'ස.', 'ප.','වි.',
            'තො.','ලං.','ගි.','භා.', 'ම.', 'මූ.', 'මෙ.','ටො.', 'රෙ.', 'සැ.', 'ම්.',
            'නො:', 'මිලි.', 'ඩබ්ලියු.', 'අවූ.', 'අවු.', 'ග.', 'ජ.', 'සි.',
            'එ.', 'යුරෝ.', 'පුද්.', 'නො.',  ## cant add ටි ex:- සිටි.
            'www.','gov.','sltnet.','gmail.','lanintegmin.', 'hotmail.', 'doc.','do.', 'yahoo.', 'infor.', 'industry.',
            'environmentmin.', 'army.',
