...
map_file =  open('C:/Users/Udhan/Desktop/FYP/MassDoc/MassivelyDocAlignment/ann/sent_to_doc_map.json',encoding='utf8')
sent_to_doc_maps = json.load(map_file)

map_file =  open('C:/Users/Udhan/Desktop/FYP/MassDoc/MassivelyDocAlignment/ann/sent_count_map.json',encoding='utf8')
...
def main_partial(source, threshold_index, threshold_length,source_lang='en'):
        ...
        for index,i in enumerate(diagonals):
            ...
            while(len(sentences_t)<(i[1][-1] - index_of_first_sentence + 1)):
        ...
        #results_outputs = {}
        #results_outputs['count'] = len(results)
        #results_outputs['results'] = results
