...
from doc_matcher import best_matching_2
...
def temp(source_doc, target_doc, source_doc_weights_sent_len_normalized,target_doc_weights_sent_len_normalized,i, j):
