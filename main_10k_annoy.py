...
file  = open('/content/gdrive/Shared drives/FYP/Embedded Data/embedding_army_0_1000.json',encoding='utf8')
data = json.load(file)
print(len(data))
...
for docs in data[:1000]:
    ...
    # source_names.append(extract_names(doc_en,'en'))
    # source_designations.append(extract_designations(doc_en,'en'))
